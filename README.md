...
- because a full autonomous scan can take longer than the live signal age limit, refresh the final selected attempt timestamp before recording/execution so brand-new candidates are not blocked as stale
