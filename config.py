...
AUTONOMOUS_EDGE_FILTER_EXPERIMENT_KEY = AUTONOMOUS_SPORTS_EDGE_FILTER_EXPERIMENT_KEY
AUTONOMOUS_ESPORTS_EDGE_FILTER_EXPERIMENT_KEY = ""
AUTONOMOUS_RETIRED_EDGE_FILTER_EXPERIMENT_KEYS = (
    "esports_edge_filter_shadow_v1",
    "esports_edge_filter_shadow_v2",
    "sports_edge_filter_shadow_v1",
)
AUTONOMOUS_ACTIVE_EDGE_FILTER_EXPERIMENT_KEYS = tuple(
    key
    for key in (
        AUTONOMOUS_SPORTS_EDGE_FILTER_EXPERIMENT_KEY,
    )
